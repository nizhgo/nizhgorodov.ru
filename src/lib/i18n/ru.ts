...
export const ru: Translations = {
	meta: {
		...
		description:
			'Frontend-инженер. Карты на Leaflet, дашборды, визуализации, WebGL. Пишу свои библиотеки, когда готовых не хватает. Открыт к релокейту и фрилансу.'
	},
	hero: {
