...
export const ru: Translations = {
	meta: {
		...
		description:
			'Frontend-инженер. Карты на Leaflet, дашборды, визуализации, WebGL. Открыт к предложениям.'
	},
	hero: {
	...
	about: {
		...
		body: [
			...
			'Закончил магистратуру ВШЭ по цифровой урбанистике — геоданные, Python, QGIS. Открыт к предложениям.'
		]
	},
	ui: {
		status: 'Статус',
