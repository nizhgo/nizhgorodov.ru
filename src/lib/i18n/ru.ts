...
export const ru: Translations = {
	meta: {
		...
		description:
			'Frontend-инженер. Карты на Leaflet, дашборды, визуализации, WebGL. Открыт к предложениям, готов к переезду.'
	},
	hero: {
	...
	about: {
		...
		body: [
			...
			'Вёл команду фронтендеров — ревью, менторинг, архитектура с нуля. На других проектах был единственным фронтом и закрывал весь фронт.',
			'Закончил магистратуру ВШЭ по цифровой урбанистике — геоданные, Python, QGIS. Открыт к предложениям, готов к переезду.'
		]
	},
	ui: {
		status: 'Статус',
		...
		work: [
			{
				...
				summary: 'Делал продукты с нуля: архитектура, код, ревью, менторинг стажёров. Карты, дашборды, аналитика, нативные приложения, своя PDF-генерация отчётов. Вёл команду фронтендеров; на других проектах был единственным фронтом.'
			},
			{
				place: 'Edya',
